...
object StudentDemo {
  def main (args: Array[String]) {
    ...
    val b6 = new Student(name = "小橙", sex = "男", Chinese = 78, Mathematics = 77, English = 83, TheClass = 2)
    ...
    val c6 = new Student(name = "大橙", sex = "男", Chinese = 68, Mathematics = 61, English = 55, TheClass = 3)
